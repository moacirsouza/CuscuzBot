...
Este Robô foi criado usando o seguinte tutorial, da Equipe do RealPython (Em inglês): [Como criar um Robô em Python](https://realpython.com/how-to-make-a-discord-bot-python).

# Hablas another linguagem?

This project is maintained by a Brazilian team, so, the majority of it will be written in Brazilian Portuguese. Although some Clan Mates are able to speak other languages (English, Spanish, a little bit of German and even Chinese!) we have no plans to make these documents available in any of them for now. Sorry about that :(
